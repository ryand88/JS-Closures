...
function callJake(phone) {
  var func = callFriend("Jake");
  return func(phone);
}
...
friends (friends of friends), and an array of all users. 
These arrays may share users. 
Write a function that takes in our existing friends and returns
...
method, 
find all potential second level friends as well as potential friends
from allUsers. */
